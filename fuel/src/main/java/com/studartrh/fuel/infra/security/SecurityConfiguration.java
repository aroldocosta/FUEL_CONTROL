    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
            ...
            .authorizeHttpRequests((authz) -> authz
        		.requestMatchers(antMatcher(HttpMethod.GET, 	"/pumps")).hasRole("USER")
        		.requestMatchers(antMatcher(HttpMethod.GET, 	"/tanks")).hasRole("USER")
        		.requestMatchers(antMatcher(HttpMethod.GET, 	"/fuelings")).hasRole("USER")
        		.requestMatchers(antMatcher(HttpMethod.GET, 	"/fuelings/totals")).hasRole("USER")
        		.requestMatchers(antMatcher(HttpMethod.GET, 	"/report")).hasRole("ADMIN")
        		.requestMatchers(antMatcher(HttpMethod.POST, 	"/fuelings")).hasRole("USER")
                .requestMatchers(antMatcher(HttpMethod.PUT, 	"/fuelings")).hasRole("ADMIN")
                .requestMatchers(antMatcher(HttpMethod.DELETE, 	"/fuelings/**")).hasRole("ADMIN")
